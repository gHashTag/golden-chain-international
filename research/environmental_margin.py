...
if __name__ == "__main__":
    ...
    print("\nAND THAT FIGURE IS THE WRONG ONE - W-INTL-236. Every row above holds the")
    print("selection fraction at the declared value, which is exactly what W-INTL-225")
    print("identified about the one-at-a-time sweep. Let the fraction move and the same")
    print("corner costs 0.25 of a tile, not 2.12: BCH(127,57,11) in nine blocks at twenty")
    print("percent retained. See research/budget_audit.py. This table is kept because it")
    print("is the right answer to a different question - what the construction as declared")
    print("absorbs - and it is not the price of the corner.")
