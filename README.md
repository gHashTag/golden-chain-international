# GOLDEN CHAIN — International Edition

**Trust-first open reference infrastructure for low-precision numeric formats and verifiable AI compute.**
...
- Anchors: `phi^2 + phi^-2 = 3`, GoldenFloat family (arXiv:2606.05017), 83-format numeric catalog (arXiv:2606.09686)
...
1. English + ASCII only in public artefacts.
2. No state-rhetoric; world-benefit level primary.
3. UAE ADGM/DIFC as primary legal vessel; Armenia backup; Singapore/Switzerland/AIFC excluded.
4. Honest energy multiplier ×4-8 (95% CI [3, 10]), never ×50-100.
5. Trinity Provenance framed as C2PA-COMPATIBLE verifier, not replacement.
